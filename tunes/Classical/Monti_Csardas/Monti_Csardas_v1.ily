...
va = \relative c'' {
  ...
  b'2->
  \tupletSpan 8
  a8-> a,,(~\fermata a32 b a gis \tuplet 3/2 { a16[ cis e)] }
  ...
  \repeat volta 2 {
    \tupletSpan 4
    c(~^\atem \tuplet 6/4 { c16 e g b c e) } g16.( f32) e16.( d32 c8 b)
    b( a) \appoggiatura { a16[ b] } a8.( gis16 a2)

    a,4(~ \tuplet 6/4 { a16 cis e g\< a cis) } e8( cis a' cis,)\!
    e( d) \appoggiatura { d16[ e] } d( cis d e f4) f
    f(^\pora b,~ b8\fermata \tuplet 7/4 { e32 f e dis e f e } \tuplet 3/2 { g8 f e) }
