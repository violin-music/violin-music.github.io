...
vCe = \lyricmode {
        ...
        Hea-2 v'nly4 hosts2 sing4 "``A-"4. lle-8 lu-4 ia2.
...
\score {
    \new ChoirStaff   <<
              { \context Lyrics = "top" \chordmode}
              \upper
              { \context Lyrics = "upper" \verseA }
              { \context Lyrics = "upper" \verseB }
              { \context Lyrics = "upper" \verseC }
              \lower
       >>
}
