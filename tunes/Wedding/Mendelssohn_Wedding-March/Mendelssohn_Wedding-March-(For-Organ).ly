...
\header {
  ...
  tagline = \markup {
    ...
    \box \center-align {
      ...
      \column {
        \line {
          Sheet music from \with-url "http://www.MutopiaProject.org" \line { \teeny www. \hspace #-1.0 MutopiaProject \hspace #-1.0 \teeny .org \hspace #0.5 }
...
problemone= <<
  {\shape #'((0.1 . 0.8) (0.0 . 1.0) (0.0 . 1.5) (-.2 . 0.6)) Slur  c2^\trill ( e4) d8. e16 |}
  \\
  {
    g,2 \grace{
      \stemUp
...
rh = \relative c' {
  ...
  \alternative {
    ...
    {
      g2~\startTrillSpan g8\stopTrillSpan r^\markup{
        \column{
          \line{Bom.}
          \line{16 p.}
        }
